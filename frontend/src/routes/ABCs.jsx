...
const Letters = () => {
    ...
    return (
        <>
            ...
            >
                <h1 className="chelsea-market-regular">ABC's </h1>
                ...
                <div className="abcBody">
                    {letters.map((letter) => (
                        <div className="flip-container" key={letter}>
                            ...
                            >
                                <div className="front">
                                    {/* <p className="chelsea-market-regular" style={{ margin: "0px" }}>{letter}</p> */}
                                    <p style={{ margin: "0px" }}>
                                        {animationPlayed === letter ? (
                                            <StarAnimation />
                                        ) : (
                                            <p
                                                style={{
